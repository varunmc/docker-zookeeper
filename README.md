...
This docker image combines Zookeeper and Exhibitor. By default, Exhibitor is configured with _exhibitor.properties_ and runs Zookeeper in standalone mode.
